...
const displayCards = (coins, currency, i) => {
  var card = `<div class="card col-sm-2 mx-sm-5" style="margin:5px; padding-left:0; padding-right:0;">
            
            <h4 class = "card-header">
                ${coins[i].name}
            </h4>
            <div class="card-body">
                <h5 class="card-title"><img src="${coins[i].iconUrl}" class="card-img-top alt="${coins[i].name}" style="height:200px; margin:10px;">${coins[i].symbol}</h5>
            </div>
